...
class TerminadosMobileWidget extends StatefulWidget {
  const TerminadosMobileWidget({
    super.key,
  ...
  @override
  _TerminadosMobileWidgetState createState() => _TerminadosMobileWidgetState();
}

class _TerminadosMobileWidgetState extends State<TerminadosMobileWidget> {
